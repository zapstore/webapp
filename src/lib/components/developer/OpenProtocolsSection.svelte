<script>
	...
	const protocols = [
		...
		},
		{
			id: 'blossom',
			title: 'Blossom',
			subtitle: 'Storage without lock-in',
	...
	<div class="open-protocols-container developer-marketing-inner">
		...
		<div class="open-protocols-col-left">
			...
			<p class="section-description open-protocols-desc">
				Open protocols make your distribution portable. Removed from one community's catalog?
				Publish to another — your users switch catalogs within the same app. No platform sits
