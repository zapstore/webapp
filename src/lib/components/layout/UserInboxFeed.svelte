...
{#if pubkey && inboxActive}
	...
	<div
		class="user-inbox-body flex-1 flex flex-col min-w-0"
		class:user-inbox-body--popover={inboxPopover}
	>
...
<style>
	/* Popover: participate in the panel’s flex height so the feed can scroll. */
	.user-inbox-body--popover {
		min-height: 0;
		overflow: hidden;
	}
</style>
